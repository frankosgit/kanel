...
export default function Home() {
  return (
      ...
      <Container className="overflow-hidden pt-[6.4rem]">
        <Hero>
          <Button href='/' variant="secondary" size="small" className="animate-fade-in opacity-0 translate--y-[-1rem]">Looking for an intern in Stockholm or remote in 2024?<FontAwesomeIcon className= " pl-1 pr-2 h-[12px]"icon={faArrowRight} style={{ color: '#ffffff' }}/></Button>
          ...
          <HeroSubtitle className="animate-fade-in [--animation-delay:400ms] opacity-0 translate--y-[-1rem]">Passion for tech, problemsolving <br className='hidden md:block'/>and a hunger to learn.
          </HeroSubtitle>
